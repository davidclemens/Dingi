classdef (SharedTestFixtures = { ...
    ...
    % times_test  Unittests for DataKit.quantity.rdivide
    % This class holds the unittests for the DataKit.quantity.rdivide method.
    %
    % It can be run with runtests('Tests.DataKit.quantity.rdivide_test').
    %
    %
