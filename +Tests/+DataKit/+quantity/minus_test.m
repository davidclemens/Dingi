classdef (SharedTestFixtures = { ...
        ...
        }) minus_test < matlab.unittest.TestCase
    % minus_test  Unittests for DataKit.quantity.minus
    % This class holds the unittests for the DataKit.quantity.minus method.
    %
    % It can be run with runtests('Tests.DataKit.quantity.minus_test').
    %
    %
    ...
    methods (Test)
        function testMinusArithmetic(testCase,BValue,BSigma,BFlag)
        ...
        function testMinusShapeCombinations(testCase,BSize)
