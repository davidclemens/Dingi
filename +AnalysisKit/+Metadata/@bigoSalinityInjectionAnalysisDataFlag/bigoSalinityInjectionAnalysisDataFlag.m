classdef bigoSalinityInjectionAnalysisDataFlag < DataKit.enum
    enumeration
        ...
        IsDuringIncubation                          (5,     NaN,        '',                 'is during incub.',  	'The value is during the incubation.')
    end
    ...
    methods
        function obj = bigoSalinityInjectionAnalysisDataFlag(id,threshold,thresholdUnit,abbreviation,description,varargin)
            obj.Id              = id;
